...
public abstract class AbstractWarGalleyEntity extends AbstractBannerUser {
   ...
   public void func_70071_h_() {
      ...
      for(int i = 0; i <= 1; ++i) {
         if (this.getPaddleState(i)) {
            if (!this.func_174814_R() && (double)(this.paddlePositions[i] % 6.2831855F) <= 0.7853981852531433D && ((double)this.paddlePositions[i] + 0.39269909262657166D) % 6.2831854820251465D >= 0.7853981852531433D) {
      ...
      if (!list.isEmpty()) {
         ...
         for(int j = 0; j < list.size(); ++j) {
            ...
            if (!entity.func_184196_w(this)) {
               if (flag && this.func_184188_bt().size() < 16 && !entity.func_184218_aH() && entity.func_213311_cf() < this.func_213311_cf() && entity instanceof LivingEntity && !(entity instanceof WaterMobEntity) && !(entity instanceof PlayerEntity)) {
   ...
   public void Watersplash() {
      ...
      float f1_1 = MathHelper.func_76126_a(this.field_70177_z * 0.017453292F) * 1.8F;
      float f0_1 = MathHelper.func_76134_b(this.field_70177_z * 0.017453292F) * 1.8F;
      float f2 = 4.0F - this.field_70146_Z.nextFloat() * 0.7F;
      float f2_ = -3.3F - this.field_70146_Z.nextFloat() * 0.7F;
      float x = 0.0F;
      ...
      for(int i = 0; i < 4; ++i) {
         ...
         this.field_70170_p.func_195594_a(ParticleTypes.field_218422_X, this.func_226277_ct_() - vector3d.field_72450_a * (double)f2 - (double)f0, this.func_226278_cu_() - vector3d.field_72448_b + 0.8D, this.func_226281_cx_() - vector3d.field_72449_c * (double)f2 - (double)f1 * 1.1D, 0.0D, 0.0D, 0.0D);
         this.field_70170_p.func_195594_a(ParticleTypes.field_218422_X, this.func_226277_ct_() - vector3d.field_72450_a * (double)f2_ + (double)f0_1, this.func_226278_cu_() - vector3d.field_72448_b + 0.8D, this.func_226281_cx_() - vector3d.field_72449_c * (double)f2_ + (double)f1_1, 0.0D, 0.0D, 0.0D);
         this.field_70170_p.func_195594_a(ParticleTypes.field_218422_X, this.func_226277_ct_() - vector3d.field_72450_a * (double)f2_ - (double)f0_1, this.func_226278_cu_() - vector3d.field_72448_b + 0.8D, this.func_226281_cx_() - vector3d.field_72449_c * (double)f2_ - (double)f1_1, 0.0D, 0.0D, 0.0D);
         this.field_70170_p.func_195594_a(ParticleTypes.field_218422_X, this.func_226277_ct_() - vector3d.field_72450_a * (double)f2_ + (double)f0_1, this.func_226278_cu_() - vector3d.field_72448_b + 0.8D, this.func_226281_cx_() - vector3d.field_72449_c * (double)f2_ + (double)f1_1 * 1.1D, 0.0D, 0.0D, 0.0D);
         this.field_70170_p.func_195594_a(ParticleTypes.field_218422_X, this.func_226277_ct_() - vector3d.field_72450_a * (double)f2_ - (double)f0_1, this.func_226278_cu_() - vector3d.field_72448_b + 0.8D, this.func_226281_cx_() - vector3d.field_72449_c * (double)f2_ - (double)f1_1 * 1.1D, 0.0D, 0.0D, 0.0D);
   ...
   public void updateMotion() {
      ...
      double d2 = 0.0D;
      double WarGalleyTurnFactor = (Double)SmallShipsConfig.WarGalleyTurnFactor.get();
      this.momentum = 1.0F;
      if (this.func_184188_bt().size() == 4) {
         this.passengerfaktor = 0.0125F;
      }

      if (this.func_184188_bt().size() == 6) {
         this.passengerfaktor = 0.025F;
      }

      if (this.func_184188_bt().size() == 10) {
         this.passengerfaktor = 0.05F;
      }

      if (this.func_184188_bt().size() == 12) {
         this.passengerfaktor = 0.075F;
      }

      if (this.func_184188_bt().size() > 12) {
         this.passengerfaktor = 0.15F;
      }
      ...
      if (this.previousStatus == TNBoatEntity.Status.IN_AIR && this.status != TNBoatEntity.Status.IN_AIR && this.status != TNBoatEntity.Status.ON_LAND) {
         ...
         this.deltaRotation = (float)((double)this.deltaRotation * (double)(this.momentum - this.passengerfaktor) * WarGalleyTurnFactor);
         if (d2 > 0.0D) {
   ...
   protected void controlBoat() {
      double WarGalleySpeedFactor = (Double)SmallShipsConfig.WarGalleySpeedFactor.get();
      ...
      if (this.func_184207_aI()) {
         ...
         if (sailstate != 0) {
            switch(sailstate) {
            case 1:
               f = (float)((double)f + 0.03999999910593033D * WarGalleySpeedFactor * 1.0D / 4.0D);
               if (this.forwardInputDown) {
                  f = (float)((double)f + 0.019999999552965164D * WarGalleySpeedFactor);
               }
               break;
            case 2:
               f = (float)((double)f + 0.03999999910593033D * WarGalleySpeedFactor * 2.0D / 4.0D);
               if (this.forwardInputDown) {
                  f = (float)((double)f + 0.019999999552965164D * WarGalleySpeedFactor);
               }
               break;
            case 3:
               f = (float)((double)f + 0.03999999910593033D * WarGalleySpeedFactor * 3.0D / 4.0D);
               if (this.forwardInputDown) {
                  f = (float)((double)f + 0.019999999552965164D * WarGalleySpeedFactor);
               }
               break;
            case 4:
               f = (float)((double)f + 0.03999999910593033D * WarGalleySpeedFactor * 1.0D);
               if (this.forwardInputDown) {
                  f = (float)((double)f + 0.019999999552965164D * WarGalleySpeedFactor);
               }
            }
         ...
         if (this.backInputDown) {
            f = (float)((double)f - 0.004999999888241291D * WarGalleySpeedFactor);
         }

         if (this.forwardInputDown && sailstate == 0) {
            f = (float)((double)f + 0.03999999910593033D * WarGalleySpeedFactor);
         }
   ...
   public boolean func_70097_a(DamageSource source, float amount) {
      double WarGalleyHealth = (Double)SmallShipsConfig.WarGalleyHealth.get();
      if (this.func_180431_b(source)) {
         ...
         if (source == DamageSource.field_76367_g) {
            ...
            if (flag || (double)this.getDamageTaken() > WarGalleyHealth) {
   ...
   public float getRowingTime(int side, float limbSwing) {
      return this.getPaddleState(side) ? (float)MathHelper.func_151238_b((double)this.paddlePositions[side] - 0.39269909262657166D, (double)this.paddlePositions[side], (double)limbSwing) : 0.0F;
   }
