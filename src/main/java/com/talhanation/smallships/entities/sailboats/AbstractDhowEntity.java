...
public abstract class AbstractDhowEntity extends AbstractBannerUser {
   ...
   public void updateMotion() {
      ...
      double d2 = 0.0D;
      double DhowTurnFactor = (Double)SmallShipsConfig.DhowTurnFactor.get();
      this.momentum = 1.0F;
      ...
      if (this.previousStatus == TNBoatEntity.Status.IN_AIR && this.status != TNBoatEntity.Status.IN_AIR && this.status != TNBoatEntity.Status.ON_LAND) {
         ...
         this.deltaRotation = (float)((double)this.deltaRotation * (double)(this.momentum - this.passengerfaktor) * DhowTurnFactor);
         if (d2 > 0.0D) {
   ...
   protected void controlBoat() {
      double DhowSpeedFactor = (Double)SmallShipsConfig.DhowSpeedFactor.get();
      ...
      if (this.func_184207_aI()) {
         ...
         if (sailstate != 0) {
            switch(sailstate) {
            case 1:
               f = (float)((double)f + 0.03999999910593033D * DhowSpeedFactor * 1.0D / 4.0D);
               break;
            case 2:
               f = (float)((double)f + 0.03999999910593033D * DhowSpeedFactor * 2.0D / 4.0D);
               break;
            case 3:
               f = (float)((double)f + 0.03999999910593033D * DhowSpeedFactor * 3.0D / 4.0D);
               break;
            case 4:
               f = (float)((double)f + 0.03999999910593033D * DhowSpeedFactor * 1.0D);
            }
         }

         if (this.backInputDown) {
            f = (float)((double)f - 0.009999999776482582D * DhowSpeedFactor);
         }
   ...
   public boolean func_70097_a(DamageSource source, float amount) {
      double DhowHealth = (Double)SmallShipsConfig.DhowHealth.get();
      if (this.func_180431_b(source)) {
         ...
         if (source == DamageSource.field_76367_g) {
            ...
            if (flag || (double)this.getDamageTaken() > DhowHealth) {
