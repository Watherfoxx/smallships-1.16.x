...
public abstract class AbstractBriggEntity extends AbstractBannerUser {
      ...
      if (!list.isEmpty()) {
         ...
         for(int j = 0; j < list.size(); ++j) {
            ...
            if (!entity.func_184196_w(this)) {
               if (flag && this.func_184188_bt().size() < 10 && !entity.func_184218_aH() && entity.func_213311_cf() < this.func_213311_cf() && entity instanceof LivingEntity && !(entity instanceof WaterMobEntity) && !(entity instanceof PlayerEntity)) {
   ...
   public void Watersplash() {
      ...
      float f0 = MathHelper.func_76134_b(this.field_70177_z * 0.017453292F) * 1.2F;
      float f1 = MathHelper.func_76126_a(this.field_70177_z * 0.017453292F) * 1.2F;
      float f2 = 4.0F - this.field_70146_Z.nextFloat() * 0.7F;
      float f2_ = -2.3F - this.field_70146_Z.nextFloat() * 0.7F;
      float x = 0.0F;
      float y = 4.0F;
      ...
      for(int i = 0; i < 2; ++i) {
         ...
         this.field_70170_p.func_195594_a(ParticleTypes.field_206864_X, this.func_226277_ct_() - vector3d.field_72450_a * (double)f2 - (double)f0, this.func_226278_cu_() - vector3d.field_72448_b + 0.5D, this.func_226281_cx_() - vector3d.field_72449_c * (double)f2 - (double)f1, 0.0D, 0.0D, 0.0D);
         this.field_70170_p.func_195594_a(ParticleTypes.field_206864_X, this.func_226277_ct_() - vector3d.field_72450_a * (double)f2 + (double)f0, this.func_226278_cu_() - vector3d.field_72448_b + 0.5D, this.func_226281_cx_() - vector3d.field_72449_c * (double)f2 + (double)f1 * 5.1D, 0.0D, 0.0D, 0.0D);
         this.field_70170_p.func_195594_a(ParticleTypes.field_206864_X, this.func_226277_ct_() - vector3d.field_72450_a * (double)f2 - (double)f0, this.func_226278_cu_() - vector3d.field_72448_b + 0.5D, this.func_226281_cx_() - vector3d.field_72449_c * (double)f2 - (double)f1 * 5.1D, 0.0D, 0.0D, 0.0D);
         ...
         this.field_70170_p.func_195594_a(ParticleTypes.field_218422_X, this.func_226277_ct_() - vector3d.field_72450_a * (double)f2 - (double)f0, this.func_226278_cu_() - vector3d.field_72448_b + 0.8D, this.func_226281_cx_() - vector3d.field_72449_c * (double)f2 - (double)f1 * 1.1D, 0.0D, 0.0D, 0.0D);
         this.field_70170_p.func_195594_a(ParticleTypes.field_218422_X, this.func_226277_ct_() - vector3d.field_72450_a * (double)f2_ + (double)f0, this.func_226278_cu_() - vector3d.field_72448_b + 0.8D, this.func_226281_cx_() - vector3d.field_72449_c * (double)(f2_ - x) + (double)f1, 0.0D, 0.0D, 0.0D);
         this.field_70170_p.func_195594_a(ParticleTypes.field_218422_X, this.func_226277_ct_() - vector3d.field_72450_a * (double)f2_ - (double)f0, this.func_226278_cu_() - vector3d.field_72448_b + 0.8D, this.func_226281_cx_() - vector3d.field_72449_c * (double)(f2_ - x) - (double)f1, 0.0D, 0.0D, 0.0D);
         this.field_70170_p.func_195594_a(ParticleTypes.field_218422_X, this.func_226277_ct_() - vector3d.field_72450_a * (double)f2_ + (double)f0, this.func_226278_cu_() - vector3d.field_72448_b + 0.8D, this.func_226281_cx_() - vector3d.field_72449_c * (double)(f2_ - x) + (double)f1 * 1.1D, 0.0D, 0.0D, 0.0D);
         this.field_70170_p.func_195594_a(ParticleTypes.field_218422_X, this.func_226277_ct_() - vector3d.field_72450_a * (double)f2_ - (double)f0, this.func_226278_cu_() - vector3d.field_72448_b + 0.8D, this.func_226281_cx_() - vector3d.field_72449_c * (double)(f2_ - x) - (double)f1 * 1.1D, 0.0D, 0.0D, 0.0D);
         this.field_70170_p.func_195594_a(ParticleTypes.field_197612_e, this.func_226277_ct_() - vector3d.field_72450_a * (double)f2_ + (double)f0, this.func_226278_cu_() - vector3d.field_72448_b + 0.8D, this.func_226281_cx_() - vector3d.field_72449_c * (double)(f2_ - x) + (double)f1, 0.0D, 0.0D, 0.0D);
         this.field_70170_p.func_195594_a(ParticleTypes.field_197612_e, this.func_226277_ct_() - vector3d.field_72450_a * (double)f2_ - (double)f0, this.func_226278_cu_() - vector3d.field_72448_b + 0.8D, this.func_226281_cx_() - vector3d.field_72449_c * (double)(f2_ - x) - (double)f1, 0.0D, 0.0D, 0.0D);
         this.field_70170_p.func_195594_a(ParticleTypes.field_197612_e, this.func_226277_ct_() - vector3d.field_72450_a * (double)f2_ + (double)f0, this.func_226278_cu_() - vector3d.field_72448_b + 0.8D, this.func_226281_cx_() - vector3d.field_72449_c * (double)(f2_ - x) + (double)f1 * 1.1D, 0.0D, 0.0D, 0.0D);
         this.field_70170_p.func_195594_a(ParticleTypes.field_197612_e, this.func_226277_ct_() - vector3d.field_72450_a * (double)f2_ - (double)f0, this.func_226278_cu_() - vector3d.field_72448_b + 0.8D, this.func_226281_cx_() - vector3d.field_72449_c * (double)(f2_ - x) - (double)f1 * 1.1D, 0.0D, 0.0D, 0.0D);
      }
   ...
   public void updateMotion() {
      ...
      double d2 = 0.0D;
      double BriggTurnFactor = (Double)SmallShipsConfig.BriggTurnFactor.get();
      this.momentum = 1.0F;
      if (this.func_184188_bt().size() == 2) {
         this.passengerfaktor = 0.0075F;
      }

      if (this.func_184188_bt().size() == 4) {
         this.passengerfaktor = 0.015F;
      }

      if (this.func_184188_bt().size() == 6) {
         this.passengerfaktor = 0.03F;
      }

      if (this.func_184188_bt().size() == 8) {
         this.passengerfaktor = 0.06F;
      }

      if (this.func_184188_bt().size() > 8) {
         this.passengerfaktor = 0.12F;
      }
      ...
      if (this.previousStatus == TNBoatEntity.Status.IN_AIR && this.status != TNBoatEntity.Status.IN_AIR && this.status != TNBoatEntity.Status.ON_LAND) {
         ...
         this.deltaRotation = (float)((double)this.deltaRotation * (double)(this.momentum - this.passengerfaktor) * BriggTurnFactor);
         if (d2 > 0.0D) {
   ...
   protected void controlBoat() {
      double BriggSpeedFactor = (Double)SmallShipsConfig.BriggSpeedFactor.get();
      ...
      if (this.func_184207_aI()) {
         ...
         if (sailstate != 0) {
            switch(sailstate) {
            case 1:
               f = (float)((double)f + 0.03999999910593033D * BriggSpeedFactor * 1.0D / 4.0D);
               break;
            case 2:
               f = (float)((double)f + 0.03999999910593033D * BriggSpeedFactor * 2.0D / 4.0D);
               break;
            case 3:
               f = (float)((double)f + 0.03999999910593033D * BriggSpeedFactor * 3.0D / 4.0D);
               break;
            case 4:
               f = (float)((double)f + 0.03999999910593033D * BriggSpeedFactor * 1.0D);
            }
         }

         if (this.backInputDown) {
            f = (float)((double)f - 0.009999999776482582D * BriggSpeedFactor);
         }
   ...
   public boolean func_70097_a(DamageSource source, float amount) {
      double BriggHealth = (Double)SmallShipsConfig.BriggHealth.get();
      if (this.func_180431_b(source)) {
         ...
         if (source == DamageSource.field_76367_g) {
            ...
            if (flag || (double)this.getDamageTaken() > BriggHealth) {
