...
public class ModelGalleySail extends ModelSail {
    ...
    public void renderToBuffer(MatrixStack matrixStack, IVertexBuilder buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        ...
        renderSail(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha, model.Mast_oben, model.Segel_z0);
        renderSail(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha, model.Mast_oben, model.Segel_z1);
        renderSail(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha, model.Mast_oben, model.Segel_z2);
        renderSail(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha, model.Mast_oben, model.Segel_z3);
        renderSail(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha, model.Mast_oben, model.Segel_z4);
        matrixStack.popPose();
    }
