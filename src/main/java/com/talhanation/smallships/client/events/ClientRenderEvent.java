...
import com.talhanation.smallships.client.render.RenderEntityDhow;
...
import com.talhanation.smallships.client.render.RenderEntityRowBoat;
...
public class ClientRenderEvent {
    ...
    public static void clientsetup(FMLClientSetupEvent event){
        ...
        RenderingRegistry.registerEntityRenderingHandler(ModEntityTypes.ROWBOAT.get(), RenderEntityRowBoat::new);
        RenderingRegistry.registerEntityRenderingHandler(ModEntityTypes.DHOW.get(), RenderEntityDhow::new);
        RenderingRegistry.registerEntityRenderingHandler(ModEntityTypes.DRAKKAR.get(), RenderEntityDrakkar::new);
